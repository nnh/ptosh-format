...
message_f <- F
rmarkdown::render(here("program", "R_wiki", "common.Rmd"), output_format="powerpoint_presentation",
...
message_f <- T
rmarkdown::render(here("program", "R_wiki", "common.Rmd"), output_format="github_document",
                  output_dir="/Users/admin/Documents/GitHub/ptosh-format.wiki/")
